#!/usr/bin/env python
"""
Package metadata for platform_plugin_lti_launch_monitor.
"""
import os
import re
import sys
...
VERSION = get_version('platform_plugin_lti_launch_monitor', '__init__.py')
...
setup(
    ...
    url='https://github.com/open-craft/platform-plugin-lti-launch-monitor',
    packages=find_packages(
        include=['platform_plugin_lti_launch_monitor', 'platform_plugin_lti_launch_monitor.*'],
        exclude=["*tests"],
    ),
