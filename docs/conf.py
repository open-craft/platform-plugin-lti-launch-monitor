...
"""
LTI Launch Monitor documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'platform-plugin-lti-launch-monitor',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/open-craft/platform-plugin-lti-launch-monitor",
...
#
# html_title = 'LTI Launch Monitor v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_plugin_lti_launch_monitor'),
                os.path.join(root_path, 'platform_plugin_lti_launch_monitor/migrations')])
